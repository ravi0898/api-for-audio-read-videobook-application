...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-bullhorn mx-2"></i>Announcement </h1>
        </div>
    </div>
    @if($message = Session::get('success_add'))
     ...
     @endif
    <section class="Addannouncementform">
            <div class="tile">
                <div class="tile-body">
                    <div class=" cst-add-new-form row">
                        <!-- <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                            <img class="w-100" src="{{ URL::asset('assets/images/terms-announcement.jpg') }}">
                        </div> -->
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                            <form class="Add-announcement-form w-auto " method="POST" action="{{route('announcement-store')}}">
                              @csrf
                              
                              <div class="form-group">
                                  <label class="form-head">Announcement Title</label>
                                  <input class="form-control  @error('announcement_name') is-invalid @enderror" name="announcement_name" value="{{ old('announcement_name') }}" id="announcement_name" type="text"  placeholder="Enter Announcement Title">
                              ...
                              <div class="form-group">
                                  <label class="form-head">Announcement Description</label>
   ...
   <section class="viewannouncement">
      <div class="row">
                     ...
                     <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tbody>
                         @if(count($announcements) > 0)
                           ...
                           <tr>
                             @php  $announcementid = Crypt::encrypt($announcement->id);  @endphp
                              <td>{{$sno}}</td>
                              <td>{{$announcement->announcement_name}}</td>
                              <td>{{$announcement->announcement_description}}</td>
                              
                              <td class="">
                                 <a href="#" class="delet-btn demoSwal" id="demoSwal" data-id="{{$announcement->id}}" data-uri="delete-announcement">
